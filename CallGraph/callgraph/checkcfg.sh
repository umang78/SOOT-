javac -cp "soot-trunk.jar" CallGraphExample.java
...
java -cp .:soot-trunk.jar CallGraphExample -soot-class-path /usr/lib/jvm/java-7-openjdk-amd64/jre/lib/rt.jar:/usr/lib/jvm/java-7-openjdk-amd64/jre/lib/jce.jar:. -pp -w -allow-phantom-refs -ire -process-dir $1 -src-prec java
